...
*   Нижче Python присвоює значення року змінній `age`
...
*   Ми більш детально подивимось на повідомлення про помилки [пізніше]({{ page.root }}/15-scope/#reading-error-messages).
...
![Ілюстрація індексації]({{ site.baseurl }}/fig/2_indexing.svg)
